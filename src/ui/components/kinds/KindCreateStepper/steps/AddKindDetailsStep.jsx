...
import AddKindDetailsForm from "../forms/AddKindDetailsForm";
...
const AddKindDetailsStep = ({
  ...
  const [targetDataModal, setTargetDataModal] = useState(null);
  ...
  return (
    <>
      ...
      <div className="mt-4 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-l">
